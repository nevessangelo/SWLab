    ...
    public static void Search(CkanClient cc, List datasets) {
        ...
        for (int i = 0; i < datasets.size(); i++) {
            ...
            for (int j = 0; j < resources.size(); j++) {
                ...
                if (name_resource != null && url != null) {
                    ...
                    for (int k = 0; k < Vname_resource.length; k++) {
                        if ((Vname_resource[k].toLowerCase().equals("dump") || Vname_resource[k].toLowerCase().equals("download") || Vname_resource[k].toLowerCase().equals("export") || Vname_resource[k].toLowerCase().equals("dataset") || Vname_resource[k].toLowerCase().equals("datasets")) && (!Vname_resource[k].toLowerCase().equals("example") || !Vname_resource[k].toLowerCase().equals("page"))) {
                            verifica_name = true;
                        }
                    }
                    ...
                    for (int k = 0; k < Vname_description.length; k++) {
                        if ((Vname_description[k].toLowerCase().equals("dump") || Vname_description[k].toLowerCase().equals("download") || Vname_description[k].toLowerCase().equals("export") || Vname_description[k].toLowerCase().equals("datasets")) && (!Vname_description[k].toLowerCase().equals("example") || !Vname_description[k].toLowerCase().equals("page"))) {
        ...
        System.out.println("Numeros de dumps encontrados: "+cont2);

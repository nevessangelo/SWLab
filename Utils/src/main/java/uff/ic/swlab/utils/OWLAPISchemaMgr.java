...
public class OWLAPISchemaMgr {
    ...
    public static OWLOntology getDBpedia() throws IOException, MalformedURLException, CompressorException,
            OWLOntologyCreationException, OWLOntologyStorageException {
        return getOntology(DBPEDIA_URL_STRING, DBPEDIA_LOCAL_NAME);
    }

    public static OWLOntology getOntology(String urlString, String localName) throws IOException, MalformedURLException,
            CompressorException, OWLOntologyCreationException, OWLOntologyStorageException {
    ...
    private static OWLOntology loadOntology(String urlString, String localName) throws IOException,
            MalformedURLException, CompressorException, OWLOntologyCreationException, OWLOntologyStorageException {
    ...
    private static OWLOntology downloadOntology(String urlString, String localName) throws MalformedURLException,
            IOException, CompressorException, OWLOntologyCreationException, OWLOntologyStorageException {
        OWLOntology ontology;
    ...
    private static OWLOntology saveOntology(final InputStream bis, String localName)

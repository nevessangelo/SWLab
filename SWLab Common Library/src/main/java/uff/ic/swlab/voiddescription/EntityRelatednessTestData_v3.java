...
public class EntityRelatednessTestData_v3 extends DatasetDescription {
    ...
    public EntityRelatednessTestData_v3() throws ParseException {
        ...
        this.root = this.description.createResource(URI, VOID.Dataset)
                ...
                .addProperty(VOID.dataDump, this.description.createResource("http://" + VoIDDescription.HOST_ADDR + "/dataset/" + NAME + ".rdf.gz"))
                .addProperty(VOID.dataDump, this.description.createResource("http://" + VoIDDescription.HOST_ADDR + "/dataset/" + NAME + ".ttl.gz"))
                .addProperty(VOID.dataDump, this.description.createResource("http://" + VoIDDescription.HOST_ADDR + "/dataset/" + NAME + ".json.gz"))
                .addProperty(VOID.dataDump, this.description.createResource("http://" + VoIDDescription.HOST_ADDR + "/dataset/" + NAME + ".nt.gz"))

...
public class DBpediaSearch {
	 ...
	 *            The keywords string.
	 * @param limit
	 *            Number of relevant resources to be retrieved.
	 * @param offset
	 *            The number of relevant resources to be skipped starting from
	 *            the top of the ranking.
	 * @param model
	 *            The RDF model for adding the description graphs.
